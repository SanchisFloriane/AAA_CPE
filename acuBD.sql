...
WHERE table_schema = 'AAA'; -- specify DB name here.
...
FOREIGN KEY (idK) REFERENCES keywords (idK);
ALTER TABLE keySympt
  ADD CONSTRAINT keySympt_symptome_idS_fk
FOREIGN KEY (idS) REFERENCES symptome (idS);


ALTER TABLE symptPatho
  ADD CONSTRAINT symptPatho_symptome_idS_fk
FOREIGN KEY (idS) REFERENCES symptome (idS);
ALTER TABLE symptPatho
  ADD CONSTRAINT symptPatho_patho_idP_fk
FOREIGN KEY (idP) REFERENCES patho (idP);
